...
export default function About() {
    ...
    const [btnState,ChangeBtnState]=useState("Enable Darkmode")
    ...
    const Dark=()=>{
        if(theme.color==='white'){
            ...
            ChangeBtnState("Enable Darkmode")
        ...
        backgroundColor:'black'
            ...
            ChangeBtnState("Disable Darkmode")
        }
    }
    ...
    return (
        ...
        <div className="container">
            <button className="btn btn-primary" onClick={Dark}>{btnState}</button>
        </div>
        </>
    )
}
